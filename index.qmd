...
TechTrend Solutions is focused on offering software solutions including risk mitigation through implementation of automated internal controls, to businesses in The Netherlands, operating from our headquarters in Tilburg. By collaborating closely with our customers, we aim to understand their needs and provide solutions that not only enhance business performance but also make meaningful contributions to the society.

Vision:

We're on a mission to be the top custom software solution provider and digital transformation consultant in The Netherlands. We thrive on constant improvement, cutting-edge methods, and exceptional customer service. Our innovative solutions focus on driving digital transformation for our clients, empowering them to grow their businesses responsibly and sustainably.

Our business model canvas:

![Business Model Canvas](https://raw.githubusercontent.com/MihaiBacos/Assignment/main/BusinessModelCanvas.png)

[Business Model Canvas](https://raw.githubusercontent.com/MihaiBacos/Assignment/main/BusinessModelCanvas.png) in a different page for better visibility and zoom options.


# Human Resources and Payroll Processes

At TechTrend Solutions, our employees are central to our success. Our HR team oversees recruitment, onboarding, benefits administration, and ensures timely and accurate payroll processing.

Managing payroll involves recording work hours, calculating gross pay, deducting taxes and benefits, and issuing clear pay stubs. At year-end, employees receive Form W-2s summarizing their earnings and taxes. Accrued payroll tracks hours worked but not yet paid, ensuring compliance and accuracy.

These processes demonstrate our commitment to employee well-being. We strive to support our team by ensuring they are compensated accurately and promptly, while adhering to all regulatory requirements.

# Acquisitions and Payments Processes

At TechTrends, getting the latest tech resources is essential. We start by identifying what each department needs and carefully choosing suppliers through evaluations and negotiations. Once we've picked the best fit, we issue purchase orders quickly to ensure we get the hardware, software, and services we need on time. When deliveries arrive, we inspect them thoroughly to make sure they meet our standards. On the financial side, we double-check invoices against our orders and delivery confirmations before making payments promptly. This process not only keeps our operations smooth but also helps us stay agile and competitive in a fast-changing tech world. Building strong relationships with our suppliers is key to staying ahead at TechTrends.
...
TechTrend Solutions markets its software goods through various web portals and partners using channel marketing strategies. The company employs sales agents who build long-term relationships with consumers and close deals. The post-sales process ensures proper invoicing and payment collections in order to maintain a favorable cash flow situation.

# Financial Reporting Process

Finally, TechTrend Solutions keeps its financial systems up to date, with processes including transaction recording, financial statements, budgeting, variance analysis, purchase order system, and different analysis done by our financial team such as variance analysis ro regularly compare our actual performance against budgeted figures to identify discrepancies and take corrective actions.
...
[Odoo website](https://mihaibacos.odoo.com/) - 

![Odoo 0 - Creating invoice lines for a new sales order](https://raw.githubusercontent.com/MihaiBacos/Assignment/main/Odoo0.png)
![Finalizing the invoice](https://raw.githubusercontent.com/MihaiBacos/Assignment/main/Odoo1.png)
![Reviewing the invoice sent to customer](https://raw.githubusercontent.com/MihaiBacos/Assignment/main/Odoo2.png)

![Recording the payment from customer](https://raw.githubusercontent.com/MihaiBacos/Assignment/main/Odoo3.png)
### Business Event 1: A New Employee Onboarding 
...
### Business Event 2: Bi-weekly Payroll Processing 
...
### Business Event 3: Employee Performance Review 
...
### Business Event 4: Employee Training Session 
...
This assignment has imparted a suitable understanding of business processes, from modeling to analysis using process mining. However, it was a bit challenging to simulate event logs and give the right interpretation of the results. This assignment has strengthened my analytical abilities and granted me a glimpse of what to expect when implementing process optimization projects in the real world. In the future, we may be able to use process mining to identify inefficiencies in processes and thereby achieve continuous improvement. The assessment also illustrated the significance of documentation to the learning process. This step was instrumental in improving our grasp of the concept.
